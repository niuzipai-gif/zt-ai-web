...
export const siteCopy = {
  zh: {
    ...
    chat: {
      ...
      researching: '正在核验公开资料', researchUnavailable: '联网核验暂时不可用', sourcesTitle: '联网来源', sourcesCount: '个来源', sourcesProvider: '来源提供方', sourceOpen: '打开来源',
