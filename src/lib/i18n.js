...
export const siteCopy = {
  ...
  ja: {
    ...
    chat: { eyebrow: 'OPEN CHAT', title: 'ZT.AIと話す', history: 'チャット履歴', newChat: '新しいチャット', resume: '履歴書ファイル', free: 'ログイン不要 · 無料', visitor: '訪問者', emptyEyebrow: 'NEW PRIVATE SESSION', emptyTitle: 'こんにちは、ZT.AIです', emptyBody: '蔡宙廷のAIデジタルツインです。プロジェクト、AIプロダクト開発、FDEについて質問できます。', emptyAction: '質問から始める', placeholder: 'ZT.AIに質問、またはファイル/画像をアップロード', generating: 'ZT.AIが回答を生成中…', upload: 'ファイルまたは画像をアップロード', publicNote: '公開対話 · ZT.AIによる回答', model: 'MODEL', historyEyebrow: 'PRIVATE SESSIONS', historyTitle: 'チャット履歴', historySection: 'この訪問者のチャット', privacyTitle: 'この訪問者だけの記録', privacyBody: '他の訪問者とチャット内容を共有しません。', sessionCount: '件のメッセージ', startPrompt: '蔡宙廷の現在のAIプロダクト開発経験を紹介してください' },
