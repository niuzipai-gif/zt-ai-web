...
export const siteCopy = {
  zh: {
    ...
    downloadCenter: { title: '把 ZT.AI 带到你的设备。', subtitle: '选择适合你的平台。Windows 桌面端与 Android 移动端已经准备好，iPhone 与 macOS 会在完成测试后陆续开放。', version: 'DESKTOP 0.2.16 · ANDROID 0.2.2 · READY', ariaLabel: '平台下载选项', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: '立即下载', expectation: '敬请期待', note: 'Windows 与 Android 安装包来自 ZT.AI 官方 GitHub Release；iPhone 与 macOS 版本会在完成测试后开放。', platforms: [{ id: 'windows', title: 'Windows 端', description: '完整的 ZT.buddy 桌面工作台，支持对话、工具协作与本机执行能力。', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.16-x64.exe' }, { id: 'android', title: 'Android 端', description: '轻量移动端入口，打开后即可继续使用 ZT.AI 的公开聊天体验。', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.2.apk' }, { id: 'apple', title: '苹果手机', description: '面向 iPhone 的轻量化体验正在设计，敬请期待后续版本。', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'Mac 原生桌面体验正在规划中，未来会提供更贴合 macOS 的工作台。', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
    ...
    chat: {
      ...
      starterPrompts: ['蔡宙廷目前在坤信主要做什么？', 'AI 选品与开品工作流具体怎样做？', '为什么他适合 AI 产品经理或 FDE？'],
      retry: '重新尝试',
      retryHint: '刚才的回答没有完成；你的问题和附件已保留。',
      ...
      voiceInput: '打开语音模式', voiceModeTitle: '和 ZT.AI 说话', voiceListening: '正在听你说', voiceProcessing: '正在整理你的话', voiceSpeaking: '正在用专属声音回答', voiceUnavailable: '语音暂时不可用，请先使用文字输入。', voicePermissionDenied: '麦克风权限未开启，请允许后重试。', voiceTranscriptPlaceholder: '说完后点击光球结束', voiceClose: '退出语音模式', voiceStop: '结束录音', voicePlay: '播放语音', voicePause: '暂停语音', voiceAiDisclosure: '以下声音为 AI 合成声音', voiceNeedProvider: '语音服务还没有配置完成，先用文字聊聊。',
      researching: '正在核验公开资料', researchUnavailable: '联网核验暂时不可用', sourcesTitle: '联网来源', sourcesCount: '个来源', sourcesProvider: '来源提供方', sourcesExpanded: '已扩展检索', sourcesQueries: '个检索方向', sourceOpen: '打开来源',
  ...
  en: {
    ...
    downloadCenter: { title: 'Bring ZT.AI to your devices.', subtitle: 'Choose your platform. Windows and Android are ready; iPhone and macOS will follow after testing.', version: 'DESKTOP 0.2.16 · ANDROID 0.2.2 · READY', ariaLabel: 'Platform download options', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: 'Download now', expectation: 'Coming soon', note: 'Windows and Android packages are served from the official ZT.AI GitHub Release; iPhone and macOS will follow after testing.', platforms: [{ id: 'windows', title: 'Windows', description: 'The full ZT.buddy desktop workspace for chat, tool collaboration, and local execution.', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.16-x64.exe' }, { id: 'android', title: 'Android', description: 'A lightweight mobile entry point for continuing the public ZT.AI chat experience on the go.', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.2.apk' }, { id: 'apple', title: 'iPhone', description: 'A lightweight iPhone experience is being designed for a later release.', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'A native Mac workspace is being planned for a future version.', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
    ...
    chat: { eyebrow: 'OPEN CHAT', title: 'Talk to ZT.AI', history: 'Chat history', newChat: 'New chat', resume: 'Resume file', free: 'No sign-in · Free', visitor: 'Visitor', emptyEyebrow: 'NEW PRIVATE SESSION', emptyTitle: 'Hello, I am ZT.AI', emptyBody: 'I am Cai Zhouting’s AI digital twin. Ask about his projects, AI product development, or FDE direction.', emptyAction: 'Start with a question', starterLabel: 'Start with one of these', starterPrompts: ['What does Cai Zhouting do at Kunxin?', 'How does his AI product-selection workflow work?', 'Why is he a good fit for AI product roles or FDE?'], retry: 'Try again', retryHint: 'The reply did not finish. Your message and attachments were kept.', compactProfile: 'Show digital profile', placeholder: 'Ask ZT.AI, or upload a file/image first', generating: 'ZT.AI is generating…', upload: 'Upload a file or image', publicNote: 'Open conversation · Usage is recorded for operations', model: 'MODEL', send: 'Send', sendFallback: 'Please review the attachment I uploaded.', gatewayError: 'ZT.AI gateway is temporarily unavailable. Please try again.', responseError: 'This conversation did not complete. Please try again.', voiceInput: 'Open voice mode', voiceModeTitle: 'Talk to ZT.AI', voiceListening: 'Listening', voiceProcessing: 'Processing your message', voiceSpeaking: 'Answering in the configured voice', voiceUnavailable: 'Voice is temporarily unavailable. Use text input for now.', voicePermissionDenied: 'Microphone permission is not enabled.', voiceTranscriptPlaceholder: 'Tap the orb when you are finished', voiceClose: 'Exit voice mode', voiceStop: 'Stop recording', voicePlay: 'Play voice', voicePause: 'Pause voice', voiceAiDisclosure: 'The voice below is AI-generated', voiceNeedProvider: 'Voice service is not configured yet. Continue by text.', researching: 'Checking current public sources', researchUnavailable: 'Web verification is temporarily unavailable', sourcesTitle: 'Web sources', sourcesCount: 'sources', sourcesProvider: 'Provider', sourcesExpanded: 'expanded', sourcesQueries: 'queries', sourceOpen: 'Open source', mediaPreparing: 'Preparing the creation, please wait…', mediaCompleted: 'Creation completed:', historyEyebrow: 'PRIVATE SESSIONS', historyTitle: 'Chat history', historySection: 'Chats for this visitor', privacyTitle: 'Private to this visitor', privacyBody: 'For operations and cost estimates, ZT.AI records a visitor ID, masked network information, model usage and conversation content; it is not shown to other visitors.', sessionCount: 'messages', startPrompt: 'Introduce Cai Zhouting’s current AI product development experience' },
  ...
  ja: {
    ...
    downloadCenter: { title: 'ZT.AIをあなたのデバイスへ。', subtitle: 'プラットフォームを選択してください。Windows版とAndroid版は利用可能、iPhoneとmacOSはテスト後に順次公開します。', version: 'DESKTOP 0.2.16 · ANDROID 0.2.2 · READY', ariaLabel: 'プラットフォームのダウンロード', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: '今すぐダウンロード', expectation: '近日公開', note: 'Windows版とAndroid版はZT.AI公式GitHub Releaseから提供しています。iPhoneとmacOSはテスト後に公開します。', platforms: [{ id: 'windows', title: 'Windows版', description: 'チャット、ツール連携、ローカル実行に対応したZT.buddyデスクトップワークスペース。', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.16-x64.exe' }, { id: 'android', title: 'Android版', description: '外出先でもZT.AIの公開チャット体験を続けられる軽量モバイル版です。', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.2.apk' }, { id: 'apple', title: 'iPhone', description: 'iPhone向けの軽量な体験を設計中です。今しばらくお待ちください。', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'macOSに最適化したネイティブワークスペースを計画中です。', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
    ...
    chat: { eyebrow: 'OPEN CHAT', title: 'ZT.AIと話す', history: 'チャット履歴', newChat: '新しいチャット', resume: '履歴書ファイル', free: 'ログイン不要 · 無料', visitor: '訪問者', emptyEyebrow: 'NEW PRIVATE SESSION', emptyTitle: 'こんにちは、ZT.AIです', emptyBody: '蔡宙廷のAIデジタルツインです。プロジェクト、AIプロダクト開発、FDEについて質問できます。', emptyAction: '質問から始める', starterLabel: 'まずはこちらから', starterPrompts: ['蔡宙廷は坤信で何をしていますか？', 'AI商品選定・ローンチの流れを教えてください。', 'AIプロダクトマネージャーやFDEに向く理由は？'], retry: 'もう一度試す', retryHint: '回答は完了しませんでした。質問と添付ファイルは保存されています。', compactProfile: 'デジタルプロフィールを表示', placeholder: 'ZT.AIに質問、またはファイル/画像をアップロード', generating: 'ZT.AIが回答を生成中…', upload: 'ファイルまたは画像をアップロード', publicNote: '公開対話 · 運用のため利用状況を記録', model: 'MODEL', send: '送信', sendFallback: 'アップロードした添付ファイルをご確認ください。', gatewayError: 'ZT.AIゲートウェイに接続できません。しばらくしてから再試行してください。', responseError: 'この対話は完了できませんでした。もう一度お試しください。', voiceInput: '音声モードを開く', voiceModeTitle: 'ZT.AIと話す', voiceListening: '聞いています', voiceProcessing: '内容を整理中', voiceSpeaking: '設定された音声で回答中', voiceUnavailable: '音声は一時的に利用できません。テキスト入力をご利用ください。', voicePermissionDenied: 'マイクの権限が有効になっていません。', voiceTranscriptPlaceholder: '終わったらオーブをタップしてください', voiceClose: '音声モードを終了', voiceStop: '録音を終了', voicePlay: '音声を再生', voicePause: '音声を一時停止', voiceAiDisclosure: 'この音声はAIによる合成です', voiceNeedProvider: '音声サービスはまだ設定されていません。テキストで続けてください。', researching: '公開情報を確認中', researchUnavailable: 'ウェブ確認を利用できません', sourcesTitle: '参照元', sourcesCount: '件', sourcesProvider: '検索元', sourcesExpanded: '拡張検索', sourcesQueries: '検索方向', sourceOpen: '参照元を開く', mediaPreparing: '生成を準備しています。少々お待ちください…', mediaCompleted: '生成結果が完成しました：', historyEyebrow: 'PRIVATE SESSIONS', historyTitle: 'チャット履歴', historySection: 'この訪問者のチャット', privacyTitle: 'この訪問者だけの記録', privacyBody: '運用とコスト見積もりのため、訪問者ID、マスクされたネットワーク情報、モデル利用量、対話内容を記録します。他の訪問者には表示しません。', sessionCount: '件のメッセージ', startPrompt: '蔡宙廷の現在のAIプロダクト開発経験を紹介してください' },
...
Object.assign(siteCopy.zh.chat, { voiceAssistant: '打开语音助手', voiceDictate: '语音转文字', voiceDictating: '停止语音转文字', voiceNeedInput: '当前浏览器没有可用的语音识别，请直接输入文字。', voiceBrowserUnsupported: '当前浏览器不提供语音识别，请改用 Safari、安卓 App 或桌面端。', voiceNetworkError: '语音识别网络连接失败，请检查网络后重试。', voiceGreeting: '你好，我是蔡宙廷的 ZT.AI。现在可以直接点击光球和我说话。', voiceGreetingLoading: '正在准备开场问候…', voiceGreetingUnavailable: '开场问候已准备好，请点击播放按钮重试。', voiceGreetingError: '开场问候暂时无法播放，请检查网络后重试。', voiceTextPlaceholder: '可直接输入；语音识别文字也会显示在这里', voiceTextInput: '输入问题或查看语音识别结果', voiceTextSend: '发送文字问题', voiceTextHint: '已识别/输入的问题，点击发送后会用蔡宙廷的 AI 音色回答', voiceReplyReady: '回答已准备好，请点击播放按钮', voiceReplyUnavailable: '回答已准备好，但自动播放被拦截，请点击播放按钮' })
Object.assign(siteCopy.en.chat, { voiceAssistant: 'Open voice assistant', voiceDictate: 'Speech to text', voiceDictating: 'Stop speech to text', voiceNeedInput: 'Speech recognition is unavailable in this browser. Type your message instead.', voiceBrowserUnsupported: 'This browser does not provide speech recognition. Use Safari, the Android app or desktop app.', voiceNetworkError: 'Speech recognition network connection failed. Check the network and try again.', voiceGreeting: 'Hi, I’m ZT.AI, Cai Zhouting’s digital twin. Tap the orb whenever you’re ready to talk.', voiceGreetingLoading: 'Preparing the greeting…', voiceGreetingUnavailable: 'The greeting is ready. Tap play to try again.', voiceGreetingError: 'The greeting could not be played. Check the network and try again.', voiceTextPlaceholder: 'Type here; recognized speech will also appear here', voiceTextInput: 'Type a question or review the transcript', voiceTextSend: 'Send text question', voiceTextHint: 'Your question is ready; tap send to hear Cai Zhouting’s AI voice answer', voiceReplyReady: 'The answer is ready. Tap play to hear it.', voiceReplyUnavailable: 'The answer is ready, but autoplay was blocked. Tap play.' })
Object.assign(siteCopy.ja.chat, { voiceAssistant: '音声アシスタントを開く', voiceDictate: '音声をテキスト化', voiceDictating: '音声入力を停止', voiceNeedInput: 'このブラウザでは音声認識を利用できません。テキストを入力してください。', voiceBrowserUnsupported: 'このブラウザは音声認識に対応していません。Safari、Androidアプリ、またはデスクトップ版をご利用ください。', voiceNetworkError: '音声認識のネットワーク接続に失敗しました。ネットワークを確認して再試行してください。', voiceGreeting: 'こんにちは、蔡宙廷のZT.AIです。準備ができたらオーブをタップして話しかけてください。', voiceGreetingLoading: '挨拶を準備しています…', voiceGreetingUnavailable: '挨拶の音声を準備しました。再生ボタンをタップしてもう一度お試しください。', voiceGreetingError: '挨拶を再生できませんでした。ネットワークを確認して再試行してください。', voiceTextPlaceholder: 'ここに入力できます。音声認識の結果も表示されます', voiceTextInput: '質問を入力するか、音声認識の結果を確認', voiceTextSend: 'テキストで送信', voiceTextHint: '質問を確認して、送信後に蔡宙廷のAI音声で回答します', voiceReplyReady: '回答の準備ができました。再生ボタンをタップしてください。', voiceReplyUnavailable: '回答の準備ができましたが、自動再生がブロックされました。再生をタップしてください。' })
...
export const resumeDocumentByLanguage = {
  zh: { path: 'resume.docx', name: '蔡宙廷_个人简历.docx' },
...
for (const copy of Object.values(siteCopy)) {
  copy.downloadCenter.version = copy.downloadCenter.version.replace('0.2.16', '0.2.26')
  copy.downloadCenter.platforms = copy.downloadCenter.platforms.map((platform) => (
    platform.id === 'windows'
      ? { ...platform, url: platform.url.replace('0.2.16', '0.2.26') }
      : platform
  ))
}
