...
export const siteCopy = {
  ...
  en: {
    ...
    chat: { eyebrow: 'OPEN CHAT', title: 'Talk to ZT.AI', history: 'Chat history', newChat: 'New chat', resume: 'Resume file', free: 'No sign-in · Free', visitor: 'Visitor', emptyEyebrow: 'NEW PRIVATE SESSION', emptyTitle: 'Hello, I am ZT.AI', emptyBody: 'I am Cai Zhouting’s AI digital twin. Ask about his projects, AI product development, or FDE direction.', emptyAction: 'Start with a question', placeholder: 'Ask ZT.AI, or upload a file/image first', generating: 'ZT.AI is generating…', upload: 'Upload a file or image', publicNote: 'Open conversation · Powered by ZT.AI', model: 'MODEL', send: 'Send', sendFallback: 'Please review the attachment I uploaded.', gatewayError: 'ZT.AI gateway is temporarily unavailable. Please try again.', responseError: 'This conversation did not complete. Please try again.', mediaPreparing: 'Preparing the creation, please wait…', mediaCompleted: 'Creation completed:', historyEyebrow: 'PRIVATE SESSIONS', historyTitle: 'Chat history', historySection: 'Chats for this visitor', privacyTitle: 'Private to this visitor', privacyBody: 'Chat content is not shared with other visitors.', sessionCount: 'messages', startPrompt: 'Introduce Cai Zhouting’s current AI product development experience' },
  ...
  ja: {
    ...
    chat: { eyebrow: 'OPEN CHAT', title: 'ZT.AIと話す', history: 'チャット履歴', newChat: '新しいチャット', resume: '履歴書ファイル', free: 'ログイン不要 · 無料', visitor: '訪問者', emptyEyebrow: 'NEW PRIVATE SESSION', emptyTitle: 'こんにちは、ZT.AIです', emptyBody: '蔡宙廷のAIデジタルツインです。プロジェクト、AIプロダクト開発、FDEについて質問できます。', emptyAction: '質問から始める', placeholder: 'ZT.AIに質問、またはファイル/画像をアップロード', generating: 'ZT.AIが回答を生成中…', upload: 'ファイルまたは画像をアップロード', publicNote: '公開対話 · ZT.AIによる回答', model: 'MODEL', send: '送信', sendFallback: 'アップロードした添付ファイルをご確認ください。', gatewayError: 'ZT.AIゲートウェイに接続できません。しばらくしてから再試行してください。', responseError: 'この対話は完了できませんでした。もう一度お試しください。', mediaPreparing: '生成を準備しています。少々お待ちください…', mediaCompleted: '生成結果が完成しました：', historyEyebrow: 'PRIVATE SESSIONS', historyTitle: 'チャット履歴', historySection: 'この訪問者のチャット', privacyTitle: 'この訪問者だけの記録', privacyBody: '他の訪問者とチャット内容を共有しません。', sessionCount: '件のメッセージ', startPrompt: '蔡宙廷の現在のAIプロダクト開発経験を紹介してください' },
