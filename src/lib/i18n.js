...
export const siteCopy = {
  zh: {
    ...
    downloadCenter: { title: '把 ZT.AI 带到你的设备。', subtitle: '选择适合你的平台。Windows 桌面端与 Android 移动端已经准备好，iPhone 与 macOS 会在完成测试后陆续开放。', version: 'DESKTOP 0.2.1 · ANDROID 0.2.1 · READY', ariaLabel: '平台下载选项', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: '立即下载', expectation: '敬请期待', note: 'Windows 与 Android 安装包来自 ZT.AI 官方 GitHub Release；iPhone 与 macOS 版本会在完成测试后开放。', platforms: [{ id: 'windows', title: 'Windows 端', description: '完整的 ZT.buddy 桌面工作台，支持对话、工具协作与本机执行能力。', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.1-x64.exe' }, { id: 'android', title: 'Android 端', description: '轻量移动端入口，打开后即可继续使用 ZT.AI 的公开聊天体验。', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.1.apk' }, { id: 'apple', title: '苹果手机', description: '面向 iPhone 的轻量化体验正在设计，敬请期待后续版本。', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'Mac 原生桌面体验正在规划中，未来会提供更贴合 macOS 的工作台。', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
  ...
  en: {
    ...
    downloadCenter: { title: 'Bring ZT.AI to your devices.', subtitle: 'Choose your platform. Windows and Android are ready; iPhone and macOS will follow after testing.', version: 'DESKTOP 0.2.1 · ANDROID 0.2.1 · READY', ariaLabel: 'Platform download options', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: 'Download now', expectation: 'Coming soon', note: 'Windows and Android packages are served from the official ZT.AI GitHub Release; iPhone and macOS will follow after testing.', platforms: [{ id: 'windows', title: 'Windows', description: 'The full ZT.buddy desktop workspace for chat, tool collaboration, and local execution.', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.1-x64.exe' }, { id: 'android', title: 'Android', description: 'A lightweight mobile entry point for continuing the public ZT.AI chat experience on the go.', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.1.apk' }, { id: 'apple', title: 'iPhone', description: 'A lightweight iPhone experience is being designed for a later release.', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'A native Mac workspace is being planned for a future version.', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
  ...
  ja: {
    ...
    downloadCenter: { title: 'ZT.AIをあなたのデバイスへ。', subtitle: 'プラットフォームを選択してください。Windows版とAndroid版は利用可能、iPhoneとmacOSはテスト後に順次公開します。', version: 'DESKTOP 0.2.1 · ANDROID 0.2.1 · READY', ariaLabel: 'プラットフォームのダウンロード', available: 'AVAILABLE', comingSoon: 'COMING SOON', download: '今すぐダウンロード', expectation: '近日公開', note: 'Windows版とAndroid版はZT.AI公式GitHub Releaseから提供しています。iPhoneとmacOSはテスト後に公開します。', platforms: [{ id: 'windows', title: 'Windows版', description: 'チャット、ツール連携、ローカル実行に対応したZT.buddyデスクトップワークスペース。', meta: 'X64 · INSTALLER', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.buddy-Desktop-0.2.1-x64.exe' }, { id: 'android', title: 'Android版', description: '外出先でもZT.AIの公開チャット体験を続けられる軽量モバイル版です。', meta: 'MOBILE · ANDROID · APK', available: true, url: 'https://github.com/niuzipai-gif/zt-ai-web/releases/latest/download/ZT.AI-Android-0.2.1.apk' }, { id: 'apple', title: 'iPhone', description: 'iPhone向けの軽量な体験を設計中です。今しばらくお待ちください。', meta: 'MOBILE · IOS', available: false, url: '' }, { id: 'macos', title: 'macOS', description: 'macOSに最適化したネイティブワークスペースを計画中です。', meta: 'DESKTOP · MACOS', available: false, url: '' }] },
