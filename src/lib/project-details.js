...
const GITHUB_URL = 'https://github.com/niuzipai-gif/zt-ai-web'

const evidence = {
  zh: [
    { label: '公开网页：可继续追问这个案例', url: PUBLIC_CHAT_URL },
    { label: 'GitHub：查看公开实现与发布记录', url: GITHUB_URL },
  ],
  en: [
    { label: 'Public site: ask follow-up questions about this case', url: PUBLIC_CHAT_URL },
    { label: 'GitHub: inspect the public implementation and releases', url: GITHUB_URL },
  ],
  ja: [
    { label: '公開サイト：この事例について追加質問できます', url: PUBLIC_CHAT_URL },
    { label: 'GitHub：公開実装とリリース履歴を確認できます', url: GITHUB_URL },
  ],
}
