...
function PlatformIcon({ platform }) {
  ...
  if (platform === 'android') return <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.65" aria-hidden="true"><path d="M7.2 10.2h9.6v8.2a1.7 1.7 0 0 1-1.7 1.7H8.9a1.7 1.7 0 0 1-1.7-1.7v-8.2Z" /><path d="M5.3 11v5.3M18.7 11v5.3M9.1 9.8 7.7 7.5M14.9 9.8l1.4-2.3M9.4 12.8v.1M14.6 12.8v.1M9.4 10.2a3.1 3.1 0 0 1 5.2 0" /></svg>
  if (platform === 'apple') return <svg width="29" height="29" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M16.9 12.6c0-2.1 1.7-3.1 1.8-3.2-1-.1-2.1 1.2-2.6 1.2-.6.1-1.4-1.1-2.4-1.1-1.2 0-2.3.7-2.9 1.8-1.3 2.2-.3 5.5.9 7.2.6.8 1.2 1.7 2.2 2.2 2.2.9 0 1.3-.6 2.4-.6 1 0 1.4.6 2.3.6 1 0 1.6-.9 2.2-1.8.7-1 1-2 1-2.1-.1 0-2.1-.8-2.1-3.2Zm-1.7-4.2c.5-.6.8-1.5.7-2.4-.7 0-1.6.5-2.1 1.1-.5.5-.8 1.4-.7 2.3.8.1 1.6-.4 2.1-1Z" /></svg>
